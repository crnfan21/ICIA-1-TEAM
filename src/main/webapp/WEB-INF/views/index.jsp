...
$(document).ready(function(){
   //document.cookie로 값을 얻어옴.
   var cookieData = document.cookie;
   //처음에 접속했을 때, 현재의 쿠키값을 얻어옴.
    //해당 쿠키에서 close 속성이 Yes인지를 찾음. 
    //만약 Yes이라면 하루동안 보지 않기를 눌렀던 유저이고(혹은 쿠키이고), 그러면 팝업 게시물을 보여주면 안됨.
    //indexOf() 메서드는 찾았으면 해당 인덱스를 리턴하는데, 리턴 값이 0보다 작다는 것은 찾지 못했다는 뜻.
    //즉, 0보다 작을 때는 보여줘야 함.
